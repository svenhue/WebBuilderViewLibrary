...
import useBtn, { useBtnProps } from 'quasar/src/components/btn/use-btn.js'

import { createComponent } from 'quasar/src/utils/private.create/create.js'
import { hMergeSlot } from 'quasar/src/utils/private.render/render.js'
import { stop, prevent, stopAndPrevent, listenOpts } from 'quasar/src/utils/event/event.js'
import { isKeyCode } from 'quasar/src/utils/private.keyboard/key-composition.js'
  ...
  setup (props, { slots, emit }) {
    ...
    return () => {
      ...
      hasLabel.value === true && inner.push(
        h('span', { "textnode": true, class: 'block', innerHTML: props.label }  )
      )
